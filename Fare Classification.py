...
#load the data set
train = pd.read_csv(r'C:\Buddhika\Documents\MLtrain.csv')
...
test=pd.read_csv(r'C:\Buddhika\Documents\MLtest.csv')
tripid=test.tripid
...
df_output[['tripid','prediction']].to_csv(r'C:\Buddhika\Documents\result.csv',index=False)
